<h2><a href="https://leetcode.com/problems/check-if-array-is-good">1793. Minimum Moves to Make Array Complementary</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> of <strong>even</strong> length <code>n</code> and an integer <code>limit</code>. In one move, you can replace any integer from <code>nums</code> with another integer between <code>1</code> and <code>limit</code>, inclusive.</p>
